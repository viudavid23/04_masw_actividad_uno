...
if (!is_bool($actorSaved)) {
    ...
    if (is_bool($personSaved) && !$personSaved) {
        $errorOccurred = true;
    }
} else {
    $errorOccurred = true;
...
<body>
    <div class="container">
        ...
        <form class="row g-3" name="create_language" action="" method="POST">
            <h2 class="h2">Edicion de Actores/Actrices</h2>
            <?php
            ...
            ?>
                    <div class="row">
                        <div class="alert alert-danger" role="alert">
                            <?php echo $_SESSION['error_message'] ?> <br><a href="list.php">Volver al listado de Actores/Actrices</a>
                        </div>
                    </div>
                <?php
                ...
                ?>
                    <div class="row">
                        <div class="alert alert-warning" role="alert">
                            <?php echo $_SESSION['warning_message'] ?> <br><a href="list.php">Volver al listado de Directores/as</a>
                        </div>
                    </div>
                <?php
                ...
                ?>
                    <div class="row">
                        <div class="alert alert-info" role="alert">
                            Diligencie los campos para editar el/la actor/actriz.
                        </div>
                    </div>
                    <?php
                } else {
